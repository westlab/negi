...
trunc:
	psql -h localhost -Uyourname yourDBname -c "truncate table save_stream; truncate table save_result; truncate table save_history; select setval('save_result_id_seq',1);select setval('save_data_id_seq',1);"
