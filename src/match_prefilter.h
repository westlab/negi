...
*/
#ifndef MATCH_PREFILTER_H_
#define MATCH_PREFILTER_H_
#pragma once
#include "packet.h"
#include "stream.h"
#include "rule.h"
...
class MatchPreFilterState{
 ...
 public:
        explicit MatchPreFilterState(Stream *stream);
        ~MatchPreFilterState();
...
#ifndef MATCH_ALL
        int AfterMatch(int mode, int j,
                 MatchPreFilterInfo *match_pre_filter_info, u_char *p_content);
        int Slide(int mode, int j, int i,
                 MatchPreFilterInfo *match_pre_filter_info, u_char *p_content);
        int BoyerMoore(int mode, int start_flag, MatchPreFilterState *state, Packet *packet,
                 int start_place, u_char *p_content, u_char *p_content_end, Rule *rule);
#endif
